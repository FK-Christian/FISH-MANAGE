<?php namespace App\Http\Controllers;
	...
	class AdminFluxMovementsNutritionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Aliment","name"=>"aliment","join"=>"aliments,id"];
