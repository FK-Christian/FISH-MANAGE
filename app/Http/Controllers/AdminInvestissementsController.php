<?php namespace App\Http\Controllers;
	...
	class AdminInvestissementsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Max To Give","name"=>"max_to_give"];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
                $postdata['status'] = ($postdata['status'] == 'true');
	    }
