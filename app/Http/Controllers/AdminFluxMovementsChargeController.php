<?php namespace App\Http\Controllers;
	...
	class AdminFluxMovementsChargeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Charge","name"=>"charge","join"=>"charges,name"];
