<?php namespace App\Http\Controllers;
	...
	class AdminFluxMovementsChangementController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Bac Source","name"=>"bac_source","join"=>"bacs,id"];
			$this->col[] = ["label"=>"Bac Destination","name"=>"bac_destination","join"=>"bacs,id"];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
	        $query->where('statut', 'CHANGEMENT_BAC');
	    }
