<?php namespace App\Http\Controllers;
	...
	class AdminAlimentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Stock En G","name"=>"stock_en_g"];
			...
			$this->form[] = ['label'=>'Stock En G','name'=>'stock_en_g','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Stock En G","name"=>"stock_en_g","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
